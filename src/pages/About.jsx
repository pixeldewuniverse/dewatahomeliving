...
const About = () => {
  ...
  const projects = [
    ...
    { name: 'Amed', location: 'Amed, Karangasem', category: 'Private House', summary: '', image: 'https://raw.githubusercontent.com/pixeldewads-digital/DHL/assets/Portfolio/Amed/1.jpeg', gallery: ['https://raw.githubusercontent.com/pixeldewuniverse/DHL/assets/Portfolio/Amed/2.jpeg']}
  ];
